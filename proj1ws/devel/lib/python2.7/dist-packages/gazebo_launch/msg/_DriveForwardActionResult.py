...
"""autogenerated by genpy from gazebo_launch/DriveForwardActionResult.msg. Do not edit."""
import codecs
import sys
...
class DriveForwardActionResult(genpy.Message):
  ...
  _type = "gazebo_launch/DriveForwardActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gazebo_launch/DriveForwardResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = gazebo_launch.msg.DriveForwardResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gazebo_launch.msg.DriveForwardResult()
