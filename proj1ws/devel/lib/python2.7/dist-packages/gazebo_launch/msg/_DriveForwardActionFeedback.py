...
"""autogenerated by genpy from gazebo_launch/DriveForwardActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class DriveForwardActionFeedback(genpy.Message):
  ...
  _type = "gazebo_launch/DriveForwardActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gazebo_launch/DriveForwardFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = gazebo_launch.msg.DriveForwardFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = gazebo_launch.msg.DriveForwardFeedback()
