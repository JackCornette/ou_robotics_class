...
"""autogenerated by genpy from custom_behavior_actions/DriveForwardAction.msg. Do not edit."""
import codecs
import sys
...
import custom_behavior_actions.msg
import genpy
import std_msgs.msg

class DriveForwardAction(genpy.Message):
  _md5sum = "be4adc308a68c471c56f105ad946f35b"
  _type = "custom_behavior_actions/DriveForwardAction"
...
"""
  ...
  _slot_types = ['custom_behavior_actions/DriveForwardActionGoal','custom_behavior_actions/DriveForwardActionResult','custom_behavior_actions/DriveForwardActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DriveForwardAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = custom_behavior_actions.msg.DriveForwardActionGoal()
      if self.action_result is None:
        self.action_result = custom_behavior_actions.msg.DriveForwardActionResult()
      if self.action_feedback is None:
        self.action_feedback = custom_behavior_actions.msg.DriveForwardActionFeedback()
    else:
      self.action_goal = custom_behavior_actions.msg.DriveForwardActionGoal()
      self.action_result = custom_behavior_actions.msg.DriveForwardActionResult()
      self.action_feedback = custom_behavior_actions.msg.DriveForwardActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_q3I().pack(_x.action_goal.goal.speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_q3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
