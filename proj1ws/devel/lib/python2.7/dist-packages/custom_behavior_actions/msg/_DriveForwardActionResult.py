...
"""autogenerated by genpy from custom_behavior_actions/DriveForwardActionResult.msg. Do not edit."""
import codecs
import sys
...
class DriveForwardActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "custom_behavior_actions/DriveForwardActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','custom_behavior_actions/DriveForwardResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DriveForwardActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = custom_behavior_actions.msg.DriveForwardResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = custom_behavior_actions.msg.DriveForwardResult()
