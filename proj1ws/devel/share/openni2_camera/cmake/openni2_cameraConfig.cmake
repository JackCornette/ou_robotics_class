...
if("TRUE" STREQUAL "TRUE")
  set(openni2_camera_SOURCE_PREFIX /home/corn0038/ou_robotics_class/proj1ws/src/openni2_camera/openni2_camera)
  set(openni2_camera_DEVEL_PREFIX /home/corn0038/ou_robotics_class/proj1ws/devel)
  ...
  set(openni2_camera_INSTALL_PREFIX /home/corn0038/ou_robotics_class/proj1ws/install)
...
if(NOT "/home/corn0038/ou_robotics_class/proj1ws/devel/include;/home/corn0038/ou_robotics_class/proj1ws/src/openni2_camera/openni2_camera/include " STREQUAL " ")
  set(openni2_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/corn0038/ou_robotics_class/proj1ws/devel/include;/home/corn0038/ou_robotics_class/proj1ws/src/openni2_camera/openni2_camera/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/corn0038/ou_robotics_class/proj1ws/src/openni2_camera/openni2_camera/${idir}'.  ${_report}")
    endif()
