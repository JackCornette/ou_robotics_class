...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_calibration_SOURCE_PREFIX /home/corn0038/ou_robotics_class/proj1ws/src/turtlebot_apps/turtlebot_calibration)
  set(turtlebot_calibration_DEVEL_PREFIX /home/corn0038/ou_robotics_class/proj1ws/devel)
  ...
  set(turtlebot_calibration_INSTALL_PREFIX /home/corn0038/ou_robotics_class/proj1ws/install)
...
if(NOT "/home/corn0038/ou_robotics_class/proj1ws/devel/include " STREQUAL " ")
  set(turtlebot_calibration_INCLUDE_DIRS "")
  set(_include_dirs "/home/corn0038/ou_robotics_class/proj1ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/corn0038/ou_robotics_class/proj1ws/src/turtlebot_apps/turtlebot_calibration/${idir}'.  ${_report}")
    endif()
