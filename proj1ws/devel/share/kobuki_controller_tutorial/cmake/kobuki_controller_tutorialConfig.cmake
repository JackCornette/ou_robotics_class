...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_controller_tutorial_SOURCE_PREFIX /home/corn0038/ou_robotics_class/proj1ws/src/kobuki/kobuki_controller_tutorial)
  set(kobuki_controller_tutorial_DEVEL_PREFIX /home/corn0038/ou_robotics_class/proj1ws/devel)
  ...
  set(kobuki_controller_tutorial_INSTALL_PREFIX /home/corn0038/ou_robotics_class/proj1ws/install)
...
if(NOT "/home/corn0038/ou_robotics_class/proj1ws/src/kobuki/kobuki_controller_tutorial/include " STREQUAL " ")
  set(kobuki_controller_tutorial_INCLUDE_DIRS "")
  set(_include_dirs "/home/corn0038/ou_robotics_class/proj1ws/src/kobuki/kobuki_controller_tutorial/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/corn0038/ou_robotics_class/proj1ws/src/kobuki/kobuki_controller_tutorial/${idir}'.  ${_report}")
    endif()
