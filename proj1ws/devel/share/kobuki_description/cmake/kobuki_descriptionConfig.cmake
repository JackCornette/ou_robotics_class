...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_description_SOURCE_PREFIX /home/corn0038/ou_robotics_class/proj1ws/src/kobuki_description)
  set(kobuki_description_DEVEL_PREFIX /home/corn0038/ou_robotics_class/proj1ws/devel)
  ...
  set(kobuki_description_INSTALL_PREFIX /home/corn0038/ou_robotics_class/proj1ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/corn0038/ou_robotics_class/proj1ws/src/kobuki_description/${idir}'.  ${_report}")
    endif()
