...
(cl:defmethod cl:initialize-instance :after ((m <DriveForward>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveForward)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_launch-msg:<DriveForward> is deprecated: use gazebo_launch-msg:DriveForward instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <DriveForward>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_launch-msg:distance-val is deprecated.  Use gazebo_launch-msg:distance instead.")
  (distance m))
