...
(cl:defmethod cl:initialize-instance :after ((m <DriveForwardFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveForwardFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_behavior_actions-msg:<DriveForwardFeedback> is deprecated: use custom_behavior_actions-msg:DriveForwardFeedback instead.")))

(cl:ensure-generic-function 'progress-val :lambda-list '(m))
(cl:defmethod progress-val ((m <DriveForwardFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_behavior_actions-msg:progress-val is deprecated.  Use custom_behavior_actions-msg:progress instead.")
  (progress m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveForwardFeedback>)))
  ...
  "custom_behavior_actions/DriveForwardFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveForwardFeedback)))
  "Returns string type for a message object of type 'DriveForwardFeedback"
  "custom_behavior_actions/DriveForwardFeedback")
