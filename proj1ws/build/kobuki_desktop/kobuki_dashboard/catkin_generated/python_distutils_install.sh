...
echo_and_run cd "/home/corn0038/ou_robotics_class/proj1ws/src/kobuki_desktop/kobuki_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/corn0038/ou_robotics_class/proj1ws/src/kobuki_desktop/kobuki_dashboard/setup.py" \
     \
    build --build-base "/home/corn0038/ou_robotics_class/proj1ws/build/kobuki_desktop/kobuki_dashboard" \
    install \
    --root="${DESTDIR-/}" \
