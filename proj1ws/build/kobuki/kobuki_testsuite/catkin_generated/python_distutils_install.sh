...
echo_and_run cd "/home/corn0038/ou_robotics_class/proj1ws/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/corn0038/ou_robotics_class/proj1ws/src/kobuki/kobuki_testsuite/setup.py" \
     \
    build --build-base "/home/corn0038/ou_robotics_class/proj1ws/build/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
